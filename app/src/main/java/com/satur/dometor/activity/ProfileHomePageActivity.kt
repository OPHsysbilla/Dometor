...
import com.satur.dometor.utils.CleanLeakUtils
import com.satur.dometor.utils.StatusBarUtil
    ...
    override fun initView() {
        ...
        mWebView.webViewClient = object : WebViewClient() {
            ...
            override fun onPageFinished(view: WebView, url: String) {
                ...
                view.loadUrl(String.format(Locale.CHINA, "javascript:document.body.style.paddingTop='%fpx'; void 0", DensityUtil.px2dp(mWebView.paddingTop.toInt())))
            }
        }
